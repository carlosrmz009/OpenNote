...
/// A faster allocator than the system one.
///
/// This workload allocates hard on every core at once — a fresh solver, its events and
/// its tables for every score, a dozen scores at a time — and that is what the Windows
/// system allocator is worst at, because it serialises across threads under contention.
#[global_allocator]
