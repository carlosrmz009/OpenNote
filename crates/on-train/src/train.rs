...
/// comparable, which is the whole point of reporting a before and an after. The hash is
/// [`crate::hash::fnv`] rather than the standard library's, which is free to change
/// between compiler versions and would move a piece across the split without saying so.
